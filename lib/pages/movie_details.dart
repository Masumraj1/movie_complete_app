...
import 'home/recommended/recommended_widget.dart';
...
Future<void> checkMovieInFireStore (Movie movie)async{
  QuerySnapshot<Movie> temp= await DatabaseUtils.readMovieFormFirebase(movie.id!);
  if(temp.docs.isEmpty){
  }else{
    movie.dataBaseId=temp.docs[0].data().dataBaseId;
    isSelected=1;
    setState(() {
    });
  }
